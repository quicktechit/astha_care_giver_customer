...
import 'package:jatri_app/src/models/return_history_model.dart';
...
class ReturnTripHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isLoading.value
        ...
        : _controller.returnData.isEmpty
            ? EmptyBoxWidget(title: 'No Return trip history available yet!')
            : ListView.builder(
      shrinkWrap: true,
