...
final DistanceTimeController distanceTimeController =Get.put(DistanceTimeController());
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isLoading.value
        ...
        : _controller.allCancelSortingTripHistoryData.value.sortedTrips!.isEmpty
              ...
              child: Column(
                children: [
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: _controller.allCancelSortingTripHistoryData.value.sortedTrips?.length??0,
                    itemBuilder: (context, index) {
                      var item = _controller.allCancelSortingTripHistoryData.value.sortedTrips?[index];
                  ...
                  //     shrinkWrap: true,
                  //     physics: NeverScrollableScrollPhysics(),
                  //     itemCount: _controller.cancelTripHistory.length,
                  //     itemBuilder: (context, index) {
                  //       var item = _controller.cancelTripHistory.value[index];
                  //
                  //       String? pickUpCoordinates =
                  //       item.map.toString();
                  ...
                  //   physics: NeverScrollableScrollPhysics(),
                  //   itemCount:
                  //   _controller.divisionCancelTripHistory.length,
                  //   itemBuilder: (context, index) {
                  //     var item = _controller
                  //         .divisionCancelTripHistory.value[index];
                  //     return InkWell(
                  //       onTap: () {
                  //         Get.to(() => SingleDivisionTripHistory(
                  //           tripId: item.tripId.toString(),
                  ...
                  //                                       child: Text(
                  //                                         truncateTextIfNeeded(
                  //                                             item.getTrip?.pickupLocation.toString() ??
                  //                                                 "",
                  //                                             maxWordsToShow),
                  //                                         maxLines: 1,
                  //                                         overflow:
                  ...
                  //                                       child: Text(
                  //                                         truncateTextIfNeeded(
                  //                                             item.getTrip?.dropoffLocation.toString() ??
                  //                                                 "",
                  //                                             maxWordsToShow),
                  //                                         maxLines: 1,
                  //                                         overflow:
                  ...
                  //   physics: NeverScrollableScrollPhysics(),
                  //   itemCount:
                  //   _controller.returnTripCancelHistory.length,
                  //   itemBuilder: (context, index) {
                  //     var item = _controller
                  //         .returnTripCancelHistory.value[index];
                  //     return InkWell(
                  //       onTap: () {
                  //         Get.to(() => SingleReturnHistoryTripDetailsPage(
                  //           tripId: item.id.toString(),
                  ...
                  //                                       child: Text(
                  //                                         truncateTextIfNeeded(
                  //                                             item.getTrip?.location.toString() ??
                  //                                                 "",
                  //                                             maxWordsToShow),
                  //                                         maxLines: 1,
                  //                                         overflow:
                  ...
                  //                                       child: Text(
                  //                                         truncateTextIfNeeded(
                  //                                             item.getTrip?.destination.toString() ??
                  //                                                 "",
                  //                                             maxWordsToShow),
                  //                                         maxLines: 1,
                  //                                         overflow:
