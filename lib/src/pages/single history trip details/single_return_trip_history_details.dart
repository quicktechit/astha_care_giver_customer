...
// import 'package:jatri_app/src/controllers/single%20trip%20details%20controller/single_return_trip_details_controller.dart';
...
// import 'package:jatri_app/src/widgets/driver_information_widget.dart';
...
// import 'package:jatri_app/src/widgets/vehicle_full%20details_widget.dart';
...
//   void initState() {
//     super.initState();
//     _controller.getReturnSingeHistory(widget.tripId).then((value) {
//       var inputText = _controller.returnTrip.value.data?.timedate.toString()??'';
...
//       ),
//       body: Obx(() => _controller.returnTrip.value.data==null
//           ? loader()
...
//                   TripInfoWidget(
//                     pick: _controller.returnTrip.value.data?.pickupLocation.toString()??'',
//                     drop: _controller.returnTrip.value.data?.dropoffLocation.toString()??'',
//                     journeyTime:
...
//                           .returnTrip.value.data?.getvehicle?.image
//                           .toString()??'',
//                     ),
...
//                       ? Container()
//                       : PartnerInfoWidget(
//                           partnerName: _controller
//                               .returnTrip.value.data?.getpartner?.name
//                               .toString()??'',
//                           partnerCall: _controller
//                               .returnTrip.value.data?.getpartner?.phone
//                               .toString()??'',
//                           partnerImg: Urls.getImageURL(
//                             endPoint: _controller
//                                 .returnTrip.value.data?.getpartner?.image
//                                 .toString()??'',
//                           ),
//                           onTap: () async {
//                             final Uri url = Uri(
...
//                           driverName: _controller
//                               .returnTrip.value.data?.assignedDriver?.name
//                               .toString()??'',
//                           driverCall: _controller
//                               .returnTrip.value.data?.assignedDriver?.phone
//                               .toString()??'',
//                           driverImg: Urls.getImageURL(
//                               endPoint: _controller
//                                   .returnTrip.value.data?.assignedDriver?.image
//                                   .toString()??''),
//                           onTap: () async {
//                             final Uri url = Uri(
//                                 scheme: 'tel',
//                                 path: _controller.returnTrip.value.data?.assignedDriver?.phone
//                                     .toString());
//
//                             if (await launchUrl(url)) {
//                               await launchUrl(url);
...
//                           title: 'Driver Info',
//                           email: _controller
//                               .returnTrip.value.data?.assignedDriver?.email
//                               .toString()??'',
//                         ),
//                   SizedBox(height: 20.h),
//
...
//                           airCondition: _controller
//                               .returnTrip.value.data?.assignedCar?.aircondition
//                               .toString()??'',
//                           metroType:
...
//                               .returnTrip.value.data?.assignedCar?.brandName
//                               .toString()??'',
//                         ),
//                   SizedBox(height: 20.h),
